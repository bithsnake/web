...
export type AppointmentStatusType = 'SCHEDULED' | 'ONGOING' | 'COMPLETED' | 'CANCELED' | 'DELETED';
export type AppointmentStatus = 'Scheduled' | 'Ongoing' | 'Completed' | 'Canceled' | 'Deleted';
...
export const APPOINTMENT_STATUS: Record<AppointmentStatusType, AppointmentStatusType> = {
  SCHEDULED: 'SCHEDULED',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
...
export type BillingStatus = 'DRAFT' | 'INVOICED' | 'PAID' | 'CANCELED' | 'DELETED' | 'OVERDUE';
...
export type StatusTagTone = 'success' | 'warning' | 'info' | 'danger' | 'neutral';
